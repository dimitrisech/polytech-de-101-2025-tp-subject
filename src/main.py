from data_agregation import (
    ...
    agregate_dim_fact_station
)
from data_consolidation import (
    create_consolidate_tables,
    consolidate_city_data_paris,
    consolidate_city_data_nantes,
    consolidate_station_data_paris,
    consolidate_station_data_nantes,
    consolidate_station_statement_data_paris,
    consolidate_station_statement_data_nantes    
)
